...
const state = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      factor: 2.25,
      // header: "Catalina",
      header: 'Transforming Your Ideas',
      image: '/transform.jpg',
      aspect: 1.5037,
      text:
    ...
    //     'Church-key subway tile helvetica thundercats plaid fingerstache pug truffaut raclette mumblecore venmo. Poke ramps artisan gentrify, hexagon intelligentsia single-origin coffee locavore kinfolk viral health goth irony snackwave.',
    // },
    {
      offset: 7,
      factor: 1.05,
      header: 'admin@jameshagood.tech',
      image: '/last.jpg',
      aspect: 1.77,
